...
likelihoods with gradient are coming soon). It provides:
...
For more details on the algorithms used in nutpie, see the paper
[Preconditioning Hamiltonian Monte Carlo by minimizing Fisher
Divergence](https://arxiv.org/abs/2603.18845). If you use nutpie in your
research, please see the [citation instructions](about.qmd#citation).
...
Stan needs access to a compiler toolchain, for which you can find installation instructions
